...
public class UCUMFormatDemo {
    ...
    public static void main(String[] args) {
        ...
        SimpleUnitFormat.getInstance().label(UCUM.PLANCK, "J·s");
        Unit<?> unit = UCUM.HOUR.divide(UCUM.PLANCK);
        System.out.println(unit);
        System.out.println(UCUMFormat.getInstance(UCUMFormat.Variant.PRINT).format(unit));
    }
}
