...
this.length||void 0==a))return f.getComputedStyle(this[0],"")[a]},replaceClass:function(a,b){if(void 0==a||void 0==b)return this;var e=function(a){c=c.replace(a in l?l[a]:l[a]=RegExp("(^|\\s)"+a+"(\\s|$)")," ")},d=0;for(;d<this.length;d++)if(void 0==a)this[d].className=b;else{var c=this[d].className;a.split(/\s+/g).concat(b.split(/\s+/g)).forEach(e);c=c.trim();this[d].className=0<c.length?(c+" "+b).trim():b}return this}});m(c,navigator.userAgent);c.__detectUA=m;c.uuid=function(){var a=function(){return(65536*
...
d=new c;if(b||"<"!==a[0]){b.html&&(b.innerHTML=b.html,delete b.html);e=h.createElement(a);for(var g in b)e[g]=b[g];d[d.length++]=e}else e=h.createElement("div"),k?MSApp.execUnsafeLocalFunction(function(){e.innerHTML=a.trim()}):e.innerHTML=a,p(e.childNodes,d);return d};c.query=function(a,b){try{return c(a,b)}catch(e){return c()}};c.bind=function(a,b,e){a.__events||(a.__events={});c.isArray(b)||(b=[b]);for(var d=0;d<b.length;d++)a.__events[b[d]]||(a.__events[b[d]]=[]),a.__events[b[d]].push(e)};c.trigger=
function(a,b,e){var d=!0;if(!a.__events)return d;c.isArray(b)||(b=[b]);c.isArray(e)||(e=[]);for(var g=0;g<b.length;g++)if(a.__events[b[g]])for(var f=a.__events[b[g]],h=0;h<f.length;h++)c.isFunction(f[h])&&!1===f[h].apply(a,e)&&(d=!1);return d};c.unbind=function(a,b,e){if(a.__events)if(void 0==b)delete a.__events;else{c.isArray(b)||(b=[b]);for(var d=0;d<b.length;d++)if(a.__events[b[d]])for(var g=a.__events[b[d]],f=0;f<g.length;f++)if(void 0==e&&delete g[f],g[f]===e){g.splice(f,1);break}}};c.cleanUpContent=
function(){};c.isObject=function(a){return"object"===typeof a};c.asap=function(a,b,e){if(!c.isFunction(a))throw"$.asap - argument is not a valid function";setTimeout(function(){a.apply(b,e)})};var n={};c.parseJS=function(a){if(a){if("string"===typeof a){var b=h.createElement("div");k?MSApp.execUnsafeLocalFunction(function(){b.innerHTML=a}):b.innerHTML=a;a=b}var c=a.getElementsByTagName("script");a=null;for(var d=0;d<c.length;d++)if(0<c[d].src.length&&!n[c[d].src]&&!k){var g=h.createElement("script");
